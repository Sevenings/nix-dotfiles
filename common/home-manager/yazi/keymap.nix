  ...
  programs.yazi.keymap = {
    ...
    mgr = {
      ...
      keymap = [
        ...
        { on = [ "c" "a" ];       run = "plugin compress";                  desc = "Compress archives"; }
        { on = [ "c" "p" ];       run = "plugin compress -p";               desc = "Compress archives (password)"; }
        { on = [ "c" "h" ];       run = "plugin compress -ph";              desc = "Compress archives (password + header)"; }
