...

{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mainMod, F2, exec, $cmdLauncher"
      "$mainMod, D, exec, actions"
      ...
      "$mainMod, 1, exec, workspace workspace 1"
      "$mainMod, 2, exec, workspace workspace 2"
      "$mainMod, 3, exec, workspace workspace 3"
      "$mainMod, 4, exec, workspace workspace 4"
      "$mainMod, 5, exec, workspace workspace 5"
      "$mainMod, 6, exec, workspace workspace 6"
      "$mainMod, 7, exec, workspace workspace 7"
      "$mainMod, 8, exec, workspace workspace 8"
      "$mainMod, 9, exec, workspace workspace 9"
      # "$mainMod, apostrophe, workspace, 9"
      "$mainMod CTRL, H, workspace, -1"
      "$mainMod CTRL, L, workspace, +1"

      # Move active window to a workspace with mainMod + SHIFT + [0-9]
      "$mainMod SHIFT, 1, exec, workspace movetoworkspace 1"
      "$mainMod SHIFT, 2, exec, workspace movetoworkspace 2"
      "$mainMod SHIFT, 3, exec, workspace movetoworkspace 3"
      "$mainMod SHIFT, 4, exec, workspace movetoworkspace 4"
      "$mainMod SHIFT, 5, exec, workspace movetoworkspace 5"
      "$mainMod SHIFT, 6, exec, workspace movetoworkspace 6"
      "$mainMod SHIFT, 7, exec, workspace movetoworkspace 7"
      "$mainMod SHIFT, 8, exec, workspace movetoworkspace 8"
      "$mainMod SHIFT, 9, exec, workspace movetoworkspace 9"

      "$mainMod CTRL, 1, exec, workspace movetoworkspacesilent 1"
      "$mainMod CTRL, 2, exec, workspace movetoworkspacesilent 2"
      "$mainMod CTRL, 3, exec, workspace movetoworkspacesilent 3"
      "$mainMod CTRL, 4, exec, workspace movetoworkspacesilent 4"
      "$mainMod CTRL, 5, exec, workspace movetoworkspacesilent 5"
      "$mainMod CTRL, 6, exec, workspace movetoworkspacesilent 6"
      "$mainMod CTRL, 7, exec, workspace movetoworkspacesilent 7"
      "$mainMod CTRL, 8, exec, workspace movetoworkspacesilent 8"
      "$mainMod CTRL, 9, exec, workspace movetoworkspacesilent 9"
